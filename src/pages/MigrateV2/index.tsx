    ...
    <BodyWrapper style={{ padding: 24 }}>
      <AutoColumn gap="16px">
        <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
          ...
          <div>
            <QuestionHelper text={<Trans>Migrate your liquidity tokens from Switch V2 to Switch V3.</Trans>} />
          </div>
        </AutoRow>

        <TYPE.body style={{ marginBottom: 8, fontWeight: 400 }}>
          <Trans>
            For each pool shown below, click migrate to remove your liquidity from Switch V2 and deposit it into
            Switch V3.
          </Trans>
        </TYPE.body>
